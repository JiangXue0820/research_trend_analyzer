"""
Helper functions for Research Trend Analyzer Agent.
...
def ensure_list(val):
    """Ensure the input is a list. If not, convert to list or return empty list."""
...
def strip_code_block(text: str) -> str:
    """Remove code block markers (```json, ```python, etc.) from text."""
...
def parse_markdown_summary(md_text: str) -> Dict:
    """
    Parse a markdown summary into structured data.
    ...
    try:
        ...
        # success
        return make_response("success", "Parsed markdown summary successfully.", parsed)
