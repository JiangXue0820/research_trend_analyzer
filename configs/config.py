...
LLM_PROVIDER = "openai"  # Options: "openai", "deepseek", "gemma", "local"
...
# If using Gemma (Google's open model) via local deployment (e.g., Ollama)
GEMMA_MODEL = "gemma-3b"  # Example model name for Gemma 
